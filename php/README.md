...
The PHP SDK for the RedTideInformation API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->English(null)->list(null, null);
...
[$result, $err] = $client->RedTideInformation(null)->load(
    ["id" => "test01"], null
);
