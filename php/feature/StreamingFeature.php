...
// RedTideInformation SDK streaming feature
...
class RedTideInformationStreamingFeature extends RedTideInformationBaseFeature
{
    ...
    private function _iterate(RedTideInformationResult $result): \Generator
    {
    ...
    private function _streamable(RedTideInformationContext $ctx): bool
    {
