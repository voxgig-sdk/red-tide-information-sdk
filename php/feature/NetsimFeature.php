...
// RedTideInformation SDK netsim feature
...
class RedTideInformationNetsimFeature extends RedTideInformationBaseFeature
{
    ...
    private function _simulate(RedTideInformationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RedTideInformationContext $ctx, array $applied): void
    {
        $client = $this->client;
