...
// RedTideInformation SDK utility: graphql
//
...
class RedTideInformationGraphql
{
    ...
    // equivalent.
    public static function body(RedTideInformationContext $ctx): mixed
    {
    ...
    public static function errors(RedTideInformationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
