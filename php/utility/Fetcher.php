...
// RedTideInformation SDK utility: fetcher

class RedTideInformationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RedTideInformationSDK/1.0)';
    ...
    public static function call(RedTideInformationContext $ctx, string $fullurl, array $fetchdef): array
    {
