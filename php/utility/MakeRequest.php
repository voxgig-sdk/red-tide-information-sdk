...
// RedTideInformation SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class RedTideInformationMakeRequest
{
    public static function call(RedTideInformationContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new RedTideInformationResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new RedTideInformationResponse($fetched);
        } else {
