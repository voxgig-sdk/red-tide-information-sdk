...
// RedTideInformation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RedTideInformationSDK::test)
...
{
    private const SDK_CLASS = 'RedTideInformationSDK';
    ...
    private const SDK_BASE = 'redtideinformation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../redtideinformation_sdk.php';
