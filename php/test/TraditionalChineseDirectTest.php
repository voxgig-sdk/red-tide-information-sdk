...
class TraditionalChineseDirectTest extends TestCase
{
    public function test_direct_list_traditional_chinese(): void
    {
        $setup = traditional_chinese_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-traditional_chinese", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
