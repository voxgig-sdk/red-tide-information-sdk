...
// RedTideInformation SDK English entity
...
class EnglishEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EnglishEntity($this->_client, $opts);
    }

    /**
     * @param English|array $args English data (assoc-array) to store.
     */
    ...
    /**
     * @return English|array The current English data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of English fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of English fields).
     */
    ...
    /**
     * List English items matching the given filter.
     *
     * @param EnglishListMatch|array|null $reqmatch Match filter (any subset
     *   of English fields) as an assoc-array; EnglishListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return English[]|array A list of English items as assoc-arrays at
