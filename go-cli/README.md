...
AQL-driven CLI and REPL for the RedTideInformation SDK. Positional arguments are
...
```sh
go build -o red-tide-information-cli ./...
```
...
./red-tide-information-cli load 1 english
./red-tide-information-cli load '{id:1}' english
