...
func registerSDKWords(r *eng.Registry, client *sdk.RedTideInformationSDK) {
...
func runOp(client *sdk.RedTideInformationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
