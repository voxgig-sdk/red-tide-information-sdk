...
local SimplifiedChineseEntity = {}
SimplifiedChineseEntity.__index = SimplifiedChineseEntity


function SimplifiedChineseEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SimplifiedChineseEntity)
  self._name = "simplified_chinese"
  self._client = client
...
function SimplifiedChineseEntity:get_name()
  return self._name
end


function SimplifiedChineseEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SimplifiedChineseEntity.new(self._client, opts)
end
...
function SimplifiedChineseEntity:mark_deleted()
  self._deleted = true
end


function SimplifiedChineseEntity:deleted()
  return true == self._deleted
end


function SimplifiedChineseEntity:data_set(args)
  if args ~= nil then
...
function SimplifiedChineseEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SimplifiedChineseEntity:match_set(args)
  if args ~= nil then
...
function SimplifiedChineseEntity:match_get()
...
function SimplifiedChineseEntity:stream(action, args, callopts)
...
function SimplifiedChineseEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SimplifiedChineseEntity
