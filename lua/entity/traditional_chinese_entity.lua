...
local TraditionalChineseEntity = {}
TraditionalChineseEntity.__index = TraditionalChineseEntity


function TraditionalChineseEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TraditionalChineseEntity)
  self._name = "traditional_chinese"
  self._client = client
...
function TraditionalChineseEntity:get_name()
  return self._name
end


function TraditionalChineseEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TraditionalChineseEntity.new(self._client, opts)
end
...
function TraditionalChineseEntity:mark_deleted()
  self._deleted = true
end


function TraditionalChineseEntity:deleted()
  return true == self._deleted
end


function TraditionalChineseEntity:data_set(args)
  if args ~= nil then
...
function TraditionalChineseEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TraditionalChineseEntity:match_set(args)
  if args ~= nil then
...
function TraditionalChineseEntity:match_get()
...
function TraditionalChineseEntity:stream(action, args, callopts)
...
---@param reqmatch TraditionalChineseListMatch
---@param ctrl? table
---@return TraditionalChinese[]
---@return string? err
function TraditionalChineseEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function TraditionalChineseEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return TraditionalChineseEntity
