...
local function make_error_util(ctx, err)
  ...
  local msg = "RedTideInformationSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = RedTideInformationError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == RedTideInformationError then
