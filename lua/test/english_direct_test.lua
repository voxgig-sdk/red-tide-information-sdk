...
describe("EnglishDirect", function()
  it("should direct-list-english", function()
    local setup = english_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-english", setup.live and "live" or "unit")
...
function english_direct_setup(mockres)
