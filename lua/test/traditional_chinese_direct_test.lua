...
describe("TraditionalChineseDirect", function()
  it("should direct-list-traditional_chinese", function()
    local setup = traditional_chinese_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-traditional_chinese", setup.live and "live" or "unit")
...
function traditional_chinese_direct_setup(mockres)
