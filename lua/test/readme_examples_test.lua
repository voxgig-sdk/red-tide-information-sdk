...
local SDK_MODULE = "red-tide-information_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["english"] = { ["test01"] = { id = "test01" } }, ["simplified_chinese"] = { ["test01"] = { id = "test01" } }, ["traditional_chinese"] = { ["test01"] = { id = "test01" } } } }'
