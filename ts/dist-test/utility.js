...
function envOverride(m) {
    if ('TRUE' === process.env.RED_TIDE_INFORMATION_TEST_LIVE ||
        'TRUE' === process.env.RED_TIDE_INFORMATION_TEST_OVERRIDE) {
    ...
    m.RED_TIDE_INFORMATION_TEST_EXPLAIN = process.env.RED_TIDE_INFORMATION_TEST_EXPLAIN || m.RED_TIDE_INFORMATION_TEST_EXPLAIN;
    return m;
}
