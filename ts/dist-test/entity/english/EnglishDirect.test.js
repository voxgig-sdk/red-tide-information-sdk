...
(0, node_test_1.describe)('EnglishDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-english', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-english', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        const result = await client.direct({
            path: 'en-data/dataset/hk-afcd-afcdlist-red-tide-location/resource/english',
            method: 'GET',
            params,
            query,
        });
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['RED_TIDE_INFORMATION_TEST_ENGLISH_ENTID'];
...
//# sourceMappingURL=EnglishDirect.test.js.map