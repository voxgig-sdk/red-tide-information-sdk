...
(0, node_test_1.describe)('TraditionalChineseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-traditional_chinese', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-traditional_chinese', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['RED_TIDE_INFORMATION_TEST_TRADITIONAL_CHINESE_ENTID'];
...
//# sourceMappingURL=TraditionalChineseDirect.test.js.map