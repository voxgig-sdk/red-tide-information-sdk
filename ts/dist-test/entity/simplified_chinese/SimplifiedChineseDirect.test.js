...
(0, node_test_1.describe)('SimplifiedChineseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.RedTideInformationSDK({
    ...
    (0, node_test_1.test)('direct-list-simplified_chinese', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-simplified_chinese', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.RED_TIDE_INFORMATION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.RedTideInformationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['RED_TIDE_INFORMATION_TEST_SIMPLIFIED_CHINESE_ENTID'];
    ...
    const client = new __1.RedTideInformationSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=SimplifiedChineseDirect.test.js.map