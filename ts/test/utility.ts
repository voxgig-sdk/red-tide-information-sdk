...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.REDTIDEINFORMATION_TEST_LIVE ||
    'TRUE' === process.env.REDTIDEINFORMATION_TEST_OVERRIDE
  ) {
  ...
  m.REDTIDEINFORMATION_TEST_EXPLAIN = process.env.REDTIDEINFORMATION_TEST_EXPLAIN || m.REDTIDEINFORMATION_TEST_EXPLAIN
