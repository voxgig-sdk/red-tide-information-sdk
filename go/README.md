# RedTideInformation Golang SDK



The Golang SDK for the RedTideInformation API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/red-tide-information-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/red-tide-information-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/red-tide-information-sdk/go=../red-tide-information-sdk/go
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *RedTideInformationSDK
```
...
### Entity interface (RedTideInformationEntity)

All entities implement the `RedTideInformationEntity` interface.
...
slice):
    ...
    english, err := client.English(nil).List(map[string]any{/* fields */}, nil)
    if err != nil { /* handle */ }
    // english is the returned record
...
Create an instance: `english := client.English(nil)`
...
```
github.com/voxgig-sdk/red-tide-information-sdk/go/
├── red-tide-information.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/red-tide-information-sdk/go`) re-exports everything needed
