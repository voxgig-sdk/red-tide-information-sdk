...
The Golang SDK for the RedTideInformation API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/red-tide-information-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/red-tide-information-sdk=../path/to/github.com/voxgig-sdk/red-tide-information-sdk
```
...
```
github.com/voxgig-sdk/red-tide-information-sdk/
...
The root package (`github.com/voxgig-sdk/red-tide-information-sdk`) re-exports everything needed
