...
const testSeed = `map[string]any{"entity": map[string]any{"english": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "simplified_chinese": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "traditional_chinese": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
