...
func NewEnglishEntity(client *core.RedTideInformationSDK, entopts map[string]any) *EnglishEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EnglishEntity) GetName() string { return e.name }
...
func (e *EnglishEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EnglishEntity) Deleted() bool {
	return e.deleted
}


func (e *EnglishEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEnglishEntity(e.client, opts)
}

func (e *EnglishEntity) Data(args ...any) any {
...
func (e *EnglishEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an English; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EnglishEntity) DataTyped(data ...English) English {
	if len(data) > 0 {
		return typedFrom[English](e.Data(asMap(data[0])))
	}
	return typedFrom[English](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through English (all fields
// optional at the wire level).
func (e *EnglishEntity) MatchTyped(match ...English) English {
	if len(match) > 0 {
		return typedFrom[English](e.Match(asMap(match[0])))
	}
	return typedFrom[English](e.Match())
}
...
func (e *EnglishEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EnglishEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *EnglishEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EnglishListMatch and returns []English. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EnglishEntity) ListTyped(reqmatch EnglishListMatch, ctrl map[string]any) ([]English, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[English](res), nil
}



func (e *EnglishEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EnglishEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EnglishEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EnglishEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
