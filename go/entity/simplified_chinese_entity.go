...
type SimplifiedChineseEntity struct {
	name    string
...
func NewSimplifiedChineseEntity(client *core.RedTideInformationSDK, entopts map[string]any) *SimplifiedChineseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SimplifiedChineseEntity) GetName() string { return e.name }
...
func (e *SimplifiedChineseEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SimplifiedChineseEntity) Deleted() bool {
	return e.deleted
}


func (e *SimplifiedChineseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSimplifiedChineseEntity(e.client, opts)
}

func (e *SimplifiedChineseEntity) Data(args ...any) any {
...
func (e *SimplifiedChineseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SimplifiedChinese; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SimplifiedChineseEntity) DataTyped(data ...SimplifiedChinese) SimplifiedChinese {
	if len(data) > 0 {
		return typedFrom[SimplifiedChinese](e.Data(asMap(data[0])))
	}
	return typedFrom[SimplifiedChinese](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SimplifiedChinese (all fields
// optional at the wire level).
func (e *SimplifiedChineseEntity) MatchTyped(match ...SimplifiedChinese) SimplifiedChinese {
	if len(match) > 0 {
		return typedFrom[SimplifiedChinese](e.Match(asMap(match[0])))
	}
	return typedFrom[SimplifiedChinese](e.Match())
}
...
func (e *SimplifiedChineseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SimplifiedChineseEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SimplifiedChineseEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SimplifiedChineseListMatch and returns []SimplifiedChinese. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SimplifiedChineseEntity) ListTyped(reqmatch SimplifiedChineseListMatch, ctrl map[string]any) ([]SimplifiedChinese, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[SimplifiedChinese](res), nil
}



func (e *SimplifiedChineseEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SimplifiedChineseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SimplifiedChineseEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SimplifiedChineseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
