...
type TraditionalChineseEntity struct {
	name    string
	client  *core.RedTideInformationSDK
...
func NewTraditionalChineseEntity(client *core.RedTideInformationSDK, entopts map[string]any) *TraditionalChineseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TraditionalChineseEntity) GetName() string { return e.name }
...
func (e *TraditionalChineseEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TraditionalChineseEntity) Deleted() bool {
	return e.deleted
}


func (e *TraditionalChineseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTraditionalChineseEntity(e.client, opts)
}

func (e *TraditionalChineseEntity) Data(args ...any) any {
...
func (e *TraditionalChineseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TraditionalChinese; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TraditionalChineseEntity) DataTyped(data ...TraditionalChinese) TraditionalChinese {
	if len(data) > 0 {
		return typedFrom[TraditionalChinese](e.Data(asMap(data[0])))
	}
	return typedFrom[TraditionalChinese](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TraditionalChinese (all fields
// optional at the wire level).
func (e *TraditionalChineseEntity) MatchTyped(match ...TraditionalChinese) TraditionalChinese {
	if len(match) > 0 {
		return typedFrom[TraditionalChinese](e.Match(asMap(match[0])))
	}
	return typedFrom[TraditionalChinese](e.Match())
}
...
func (e *TraditionalChineseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TraditionalChineseEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TraditionalChineseEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TraditionalChineseListMatch and returns []TraditionalChinese. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TraditionalChineseEntity) ListTyped(reqmatch TraditionalChineseListMatch, ctrl map[string]any) ([]TraditionalChinese, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TraditionalChinese](res), nil
}



func (e *TraditionalChineseEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TraditionalChineseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TraditionalChineseEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TraditionalChineseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
