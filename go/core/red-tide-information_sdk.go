...
type RedTideInformationSDK struct {
	Mode     string
...
func (sdk *RedTideInformationSDK) OptionsMap() map[string]any {
...
func (sdk *RedTideInformationSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *RedTideInformationSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *RedTideInformationSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RedTideInformationSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *RedTideInformationSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *RedTideInformationSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("RedTideInformationSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *RedTideInformationSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RedTideInformationSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("RedTideInformationSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *RedTideInformationSDK {
	...
	sdk := NewRedTideInformationSDK(sdkopts)
	sdk.Mode = "test"
