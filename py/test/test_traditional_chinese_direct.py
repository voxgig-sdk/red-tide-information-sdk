...
class TestTraditionalChineseDirect:

    def test_should_direct_list_traditional_chinese(self):
        setup = _traditional_chinese_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-traditional_chinese", "live" if setup["live"] else "unit")
        if _skip:
...
def _traditional_chinese_direct_setup(mockres):
