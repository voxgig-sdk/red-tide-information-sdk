# RedTideInformation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RedTideInformationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RedTideInformationSDK(...) and RedTideInformationSDK.test(...) become
#      RedTideInformationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "redtideinformation_sdk"
_SDK_CLASS = "RedTideInformationSDK"
