# RedTideInformation Python SDK



The Python SDK for the RedTideInformation API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.English()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/red-tide-information-sdk/releases)) or
...
| --- | --- | --- |
| `date` | `str` | Date when the red tide was sighted |
| `location` | `str` | Location in Hong Kong waters where the red tide was observed |
| `remarks` | `str` | Additional remarks or observations |
| `species` | `str` | Species causing the red tide |
| `status` | `str` | Current status of the red tide event |
...
```
py/
├── redtideinformation_sdk.py         -- Main SDK module
...
The main module (`redtideinformation_sdk`) exports the SDK class.
