...
from redtideinformation_sdk.core.control import RedTideInformationControl
...
from redtideinformation_sdk.core.helpers import get_ctx_prop, to_map
...
class RedTideInformationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = RedTideInformationControl()
        ...
        if isinstance(sp, RedTideInformationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RedTideInformationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RedTideInformationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return RedTideInformationOperation({})
    ...
    def make_error(self, code, msg):
        return RedTideInformationError(code, msg, self)
