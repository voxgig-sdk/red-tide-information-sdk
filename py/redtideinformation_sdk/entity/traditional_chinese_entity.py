...
from redtideinformation_sdk.redtideinformation_types import (
    TraditionalChinese,
...
class TraditionalChineseEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TraditionalChineseEntity(self._client, opts)
    ...
    def data_get(self) -> TraditionalChinese:
    ...
    def match_get(self) -> TraditionalChinese:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[TraditionalChinese]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.TraditionalChinese().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
