...
from redtideinformation_sdk.utility import register

# Load features
from redtideinformation_sdk.feature.base_feature import RedTideInformationBaseFeature
from redtideinformation_sdk.features import _has_feature, _make_feature
...
class RedTideInformationSDK:
    ...
    def get_utility(self):
        return RedTideInformationUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RedTideInformationSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def English(self, data=None) -> "EnglishEntity":
        ...
        from redtideinformation_sdk.entity.english_entity import EnglishEntity
    ...
    def SimplifiedChinese(self, data=None) -> "SimplifiedChineseEntity":
        ...
        from redtideinformation_sdk.entity.simplified_chinese_entity import SimplifiedChineseEntity
    ...
    def TraditionalChinese(self, data=None) -> "TraditionalChineseEntity":
        ...
        from redtideinformation_sdk.entity.traditional_chinese_entity import TraditionalChineseEntity
