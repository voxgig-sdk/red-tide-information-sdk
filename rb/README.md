# RedTideInformation Ruby SDK



The Ruby SDK for the RedTideInformation API — an entity-oriented client using idiomatic Ruby conventions.
...
```
rb/
├── RedTideInformation_sdk.rb       -- Main SDK module
