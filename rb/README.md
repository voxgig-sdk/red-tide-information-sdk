...
The Ruby SDK for the RedTideInformation API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.RedTideInformation(nil).load(
  { "id" => "test01" }, nil
)
