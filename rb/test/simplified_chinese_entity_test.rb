...
class SimplifiedChineseEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set REDTIDEINFORMATION_TEST_SIMPLIFIED_CHINESE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def simplified_chinese_basic_setup(extra)
  ...
  entid_env_raw = ENV["REDTIDEINFORMATION_TEST_SIMPLIFIED_CHINESE_ENTID"]
