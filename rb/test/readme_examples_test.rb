...
#      offline in seeded test mode (RedTideInformationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "RedTideInformation_sdk.rb")
  SDK_CLASS = "RedTideInformationSDK"
  ...
  SDK_BASE = "RedTideInformation_sdk"
