...
class EnglishEntity
  ...
  def make
    opts = @_entopts.dup
    EnglishEntity.new(@_client, opts)
  end
  ...
  # @return [English, Hash] the current English data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of English fields)
  def match_get
  ...
  #
  # @param reqmatch [EnglishListMatch, Hash, nil] match filter (any subset of
  #   English fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<English>, Array] the matching English items; raises RedTideInformationError on failure
