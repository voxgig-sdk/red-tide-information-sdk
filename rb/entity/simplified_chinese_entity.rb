...
class SimplifiedChineseEntity
  ...
  def make
    opts = @_entopts.dup
    SimplifiedChineseEntity.new(@_client, opts)
  end
  ...
  # @return [SimplifiedChinese, Hash] the current SimplifiedChinese data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of SimplifiedChinese fields)
  def match_get
  ...
  #
  # @param reqmatch [SimplifiedChineseListMatch, Hash, nil] match filter (any subset of
  #   SimplifiedChinese fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<SimplifiedChinese>, Array] the matching SimplifiedChinese items; raises RedTideInformationError on failure
