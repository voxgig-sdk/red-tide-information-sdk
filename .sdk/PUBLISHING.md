...
|---|---|---|
| `ts/` | @voxgig-sdk/red-tide-information-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/red-tide-information-sdk \
      --repository voxgig-sdk/red-tide-information-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/red-tide-information-sdk` shows it, and
`npm trust revoke @voxgig-sdk/red-tide-information-sdk --id=<id>` removes it.
