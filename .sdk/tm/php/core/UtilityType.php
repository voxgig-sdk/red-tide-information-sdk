...
// RedTideInformation SDK utility type

class RedTideInformationUtility
{
    ...
    public static function copy(RedTideInformationUtility $src): RedTideInformationUtility
    {
        $u = new RedTideInformationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
