...
// RedTideInformation SDK pipeline test
//
...
{
    private static function utility(): RedTideInformationUtility
    {
        return new RedTideInformationUtility();
    }
    ...
    private static function ctx(array $over = []): RedTideInformationContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new RedTideInformationContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new RedTideInformationOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof RedTideInformationError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new RedTideInformationOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = RedTideInformationMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new RedTideInformationOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = RedTideInformationMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new RedTideInformationOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = RedTideInformationMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RedTideInformationSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = RedTideInformationMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new RedTideInformationResponse([]),
            'result' => new RedTideInformationResult([]),
        ]);
        [, $err] = RedTideInformationMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new RedTideInformationSpec([]),
            'response' => null,
            'result' => new RedTideInformationResult([]),
        ]);
        [, $err] = RedTideInformationMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new RedTideInformationSpec(['step' => 's']),
            'response' => new RedTideInformationResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new RedTideInformationResult([]),
        ]);
        [, $err] = RedTideInformationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new RedTideInformationSpec(['step' => 's']),
            'response' => new RedTideInformationResponse(self::resp(200, ['v' => 1])),
            'result' => new RedTideInformationResult([]),
        ]);
        [, $err] = RedTideInformationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new RedTideInformationSpec(['step' => 's']),
            'response' => new RedTideInformationResponse(self::resp(200, ['v' => 2])),
            'result' => new RedTideInformationResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        RedTideInformationMakeResponse::call($ctx);
    ...
    {
        $preset = new RedTideInformationResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new RedTideInformationSpec([]),
            'response' => new RedTideInformationResponse([]),
            'result' => new RedTideInformationResult([]),
        ...
        [$got, $err] = RedTideInformationMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new RedTideInformationResult([])]);
        [, $err] = RedTideInformationMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new RedTideInformationSpec([]), 'result' => null]);
        [, $err] = RedTideInformationMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RedTideInformationSpec(['step' => 's']),
            'result' => new RedTideInformationResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new RedTideInformationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RedTideInformationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RedTideInformationSpec(['step' => 's']),
            'result' => new RedTideInformationResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new RedTideInformationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RedTideInformationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RedTideInformationResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new RedTideInformationSpec([]),
            'result' => new RedTideInformationResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = RedTideInformationMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RedTideInformationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new RedTideInformationError('boom', 'boom');
        $utility->fetcher = function (RedTideInformationContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RedTideInformationSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = RedTideInformationMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (RedTideInformationContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = RedTideInformationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(RedTideInformationResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        RedTideInformationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (RedTideInformationContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RedTideInformationSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = RedTideInformationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new RedTideInformationResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new RedTideInformationSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = RedTideInformationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = RedTideInformationMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = RedTideInformationMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new RedTideInformationResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, RedTideInformationDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new RedTideInformationResult(['ok' => false])]);
        $this->expectException(RedTideInformationError::class);
        RedTideInformationDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new RedTideInformationResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', RedTideInformationMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        RedTideInformationMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new RedTideInformationBaseFeature();
        $b = new RedTideInformationBaseFeature();
        RedTideInformationFeatureAdd::call($ctx, $a);
        RedTideInformationFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): RedTideInformationBaseFeature
    {
        $f = new RedTideInformationBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        RedTideInformationFeatureAdd::call($ctx, self::named_feature('a'));
        RedTideInformationFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        RedTideInformationFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        RedTideInformationFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        RedTideInformationFeatureAdd::call($ctx, $replace);
        ...
        RedTideInformationFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): RedTideInformationContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new RedTideInformationSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RedTideInformationPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        RedTideInformationPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new RedTideInformationResponse(['headers' => null]),
            'result' => new RedTideInformationResult([]),
        ]);
        RedTideInformationResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        RedTideInformationResultBody::call($ctx);
