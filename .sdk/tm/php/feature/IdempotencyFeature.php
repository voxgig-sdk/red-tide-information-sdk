...
// RedTideInformation SDK idempotency feature
...
class RedTideInformationIdempotencyFeature extends RedTideInformationBaseFeature
{
    ...
    private function _mutating(RedTideInformationContext $ctx): bool
    {
