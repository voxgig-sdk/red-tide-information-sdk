...
// RedTideInformation SDK rbac feature
...
class RedTideInformationRbacFeature extends RedTideInformationBaseFeature
{
    ...
    private function _required(RedTideInformationContext $ctx): ?string
    {
    ...
    private function _reject(RedTideInformationContext $ctx, string $required): void
    {
    ...
    private function _track(RedTideInformationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
