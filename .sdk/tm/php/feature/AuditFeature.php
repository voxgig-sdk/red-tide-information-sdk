...
// RedTideInformation SDK audit feature
...
class RedTideInformationAuditFeature extends RedTideInformationBaseFeature
{
    ...
    private function _emit(RedTideInformationContext $ctx, string $outcome): void
    {
