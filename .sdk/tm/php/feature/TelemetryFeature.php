...
// RedTideInformation SDK telemetry feature
...
class RedTideInformationTelemetryFeature extends RedTideInformationBaseFeature
{
    ...
    private function _close(RedTideInformationContext $ctx, bool $ok): void
    {
