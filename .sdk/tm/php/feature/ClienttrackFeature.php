...
// RedTideInformation SDK clienttrack feature
...
class RedTideInformationClienttrackFeature extends RedTideInformationBaseFeature
{
    ...
    public function PostConstruct(RedTideInformationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RedTideInformation-SDK';
