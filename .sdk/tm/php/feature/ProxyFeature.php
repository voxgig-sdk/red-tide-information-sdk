...
// RedTideInformation SDK proxy feature
...
class RedTideInformationProxyFeature extends RedTideInformationBaseFeature
{
    ...
    public function init(RedTideInformationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RedTideInformationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
