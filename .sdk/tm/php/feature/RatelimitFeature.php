...
// RedTideInformation SDK ratelimit feature
...
class RedTideInformationRatelimitFeature extends RedTideInformationBaseFeature
{
    ...
    private function _acquire(RedTideInformationContext $ctx): void
    {
    ...
    private function _track(RedTideInformationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
