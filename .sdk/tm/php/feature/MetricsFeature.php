...
// RedTideInformation SDK metrics feature
...
class RedTideInformationMetricsFeature extends RedTideInformationBaseFeature
{
    ...
    private function _record(RedTideInformationContext $ctx, bool $ok): void
    {
