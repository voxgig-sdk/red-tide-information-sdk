...
// RedTideInformation SDK timeout feature
...
class RedTideInformationTimeoutFeature extends RedTideInformationBaseFeature
{
    ...
    private function _with_timeout(RedTideInformationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RedTideInformationContext $_ctx, float $ms): void
    {
        $client = $this->client;
