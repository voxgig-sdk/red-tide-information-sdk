...
// RedTideInformation SDK cache feature
...
class RedTideInformationCacheFeature extends RedTideInformationBaseFeature
{
    ...
    private function _through(RedTideInformationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
