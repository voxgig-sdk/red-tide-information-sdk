...
// RedTideInformation SDK utility: make_options

class RedTideInformationMakeOptions
{
    ...
    public static function call(RedTideInformationContext $ctx): array
    {
        ...
        //
        // `RedTideInformationSchema::optspec()` is built from the model:
        ...
        $optspec = RedTideInformationSchema::optspec();
