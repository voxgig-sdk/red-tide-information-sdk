...
// RedTideInformation SDK utility: result_basic

class RedTideInformationResultBasic
{
    public static function call(RedTideInformationContext $ctx): ?RedTideInformationResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof RedTideInformationError) ? $result->err->msg : (string)$result->err;
