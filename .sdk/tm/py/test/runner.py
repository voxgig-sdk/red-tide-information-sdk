...
class RedTideInformationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RedTideInformationTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = RedTideInformationTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = RedTideInformationTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
