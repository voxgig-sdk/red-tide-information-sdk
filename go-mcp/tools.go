...
type Args struct {
	Entity string         `json:"entity" jsonschema:"english | simplified_chinese | traditional_chinese"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.RedTideInformationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "red-tide-information_list",
		Description: "List records from RedTideInformation. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "red-tide-information_load",
		Description: "Load a single record from RedTideInformation. " +
...
func runOp(client *sdk.RedTideInformationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.RedTideInformationSDK, name string) (sdk.RedTideInformationEntity, error) {
	switch strings.ToLower(name) {
	case "english":
		return client.English(nil), nil
	case "simplified_chinese":
		return client.SimplifiedChinese(nil), nil
	case "traditional_chinese":
		return client.TraditionalChinese(nil), nil
