// Command RedTideInformation-mcp is an MCP server exposing the RedTideInformation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	RedTideInformation_list  — list records of an entity
//	RedTideInformation_load  — load a single record of an entity
//
